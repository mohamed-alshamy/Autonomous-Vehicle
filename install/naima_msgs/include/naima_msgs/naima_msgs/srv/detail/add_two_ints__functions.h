...
#ifndef NAIMA_MSGS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
#define NAIMA_MSGS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
 ...
 * calls
 * naima_msgs__srv__AddTwoInts_Request__init().
...
/**
 * It calls
 * naima_msgs__srv__AddTwoInts_Request__fini()
 ...
 * naima_msgs__srv__AddTwoInts_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * naima_msgs__srv__AddTwoInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * naima_msgs__srv__AddTwoInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_naima_msgs
...
/**
 * It calls
 * naima_msgs__srv__AddTwoInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_naima_msgs
...
/**
 * It allocates the memory for the array and calls
 * naima_msgs__srv__AddTwoInts_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_naima_msgs
...
/**
 * It calls
 * naima_msgs__srv__AddTwoInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAIMA_MSGS__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
