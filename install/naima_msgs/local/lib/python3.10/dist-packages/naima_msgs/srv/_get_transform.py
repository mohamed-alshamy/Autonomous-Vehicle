...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from naima_msgs.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from naima_msgs.srv._get_transform import GetTransform_Request as Request
    from naima_msgs.srv._get_transform import GetTransform_Response as Response
