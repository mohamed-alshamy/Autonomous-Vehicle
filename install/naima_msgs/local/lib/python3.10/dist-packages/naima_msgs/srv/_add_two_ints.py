...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from naima_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from naima_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from naima_msgs.srv._add_two_ints import AddTwoInts_Response as Response
