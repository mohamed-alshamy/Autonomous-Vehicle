...
#include "naima_msgs/srv/get_transform.hpp"
...
private: 
    ...
    bool getTransformCallback(const std::shared_ptr<naima_msgs::srv::GetTransform::Request> req,
                              const std::shared_ptr<naima_msgs::srv::GetTransform::Response> res);

    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Service<naima_msgs::srv::GetTransform>::SharedPtr get_transform_srv_;
