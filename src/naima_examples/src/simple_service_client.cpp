...
public:
    ...
    {
        client_ = create_client<naima_msgs::srv::AddTwoInts>("add_two_ints");

        auto request = std::make_shared<naima_msgs::srv::AddTwoInts::Request>();
        request->a = a;
        request->b = b;
...
private:
    rclcpp::Client<naima_msgs::srv::AddTwoInts>::SharedPtr client_;

    void responseCallback(rclcpp::Client<naima_msgs::srv::AddTwoInts>::SharedFuture future)
    {
        if(future.valid())
        {
