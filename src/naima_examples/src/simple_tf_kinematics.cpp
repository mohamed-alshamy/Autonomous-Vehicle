#include "naima_examples/simple_tf_kinematics.hpp"
      ...
      rotations_counter_(0)
{
  ...
  static_transform_stamped_.header.frame_id = "naima_base";
  static_transform_stamped_.child_frame_id = "naima_top";
  ...
  // Service Server
  get_transform_srv_ = create_service<naima_msgs::srv::GetTransform>("get_transform", std::bind(&SimpleTfKinematics::getTransformCallback, this, _1, _2));
...
{  
  ...
  dynamic_transform_stamped_.child_frame_id = "naima_base";
...
bool SimpleTfKinematics::getTransformCallback(const std::shared_ptr<naima_msgs::srv::GetTransform::Request> req,
                                              const std::shared_ptr<naima_msgs::srv::GetTransform::Response> res)
{
