...
class KinematicBicycleModel(Node):
    ...
    def cmd_vel_callback(self, msg: Twist):
        self.v = msg.linear.x
        steering_angle_deg = math.degrees(msg.angular.z)
        # Clamp steering angle to [-15, 15] degrees
        steering_angle_deg = max(-15.0, min(15.0, steering_angle_deg))
        self.delta = steering_angle_deg
        # self.get_logger().info(f'Received cmd_vel: v={self.v:.2f}, delta={self.delta:.2f}')
